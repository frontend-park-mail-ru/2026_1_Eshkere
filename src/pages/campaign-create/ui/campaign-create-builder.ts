    ...
    formats: [
      {
        ...
        description: 'Универсальный блок в ленте публикаций для любого контента',
      ...
      },
      {
        value: 'stories',
        label: 'Stories / Reels',
        description: 'Полноэкранный вертикальный формат для мобильных историй',
        platforms: ['Mobile'],
        meta: 'Вертикальный',
      ...
      },
      {
        ...
        description: 'Ролик до 15 секунд перед видеоконтентом на сайте',
        platforms: ['Desktop', 'Mobile'],
        meta: '15 сек',
