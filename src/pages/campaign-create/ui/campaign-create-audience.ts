...
import audienceControlsTemplate from 'features/campaign-builder/ui/audience-controls.hbs';
import audienceSummaryTemplate from 'features/campaign-builder/ui/audience-summary.hbs';
import savedAudienceListTemplate from 'features/campaign-builder/ui/saved-audience-list.hbs';
import {
  DEFAULT_STATE,
  PROFILE_AGE_OPTIONS,
  PROFILE_TAG_RULES,
...
export function getAudienceModalConfig(
